...
.e-listview .e-icons:not(.e-primary .e-icon-btn) {
  color: #6b7280;
}
.e-listview .e-icons:not(.e-primary .e-icon-btn).e-back-button:hover, .e-listview .e-icons:not(.e-primary .e-icon-btn).e-icon-collapsible:hover {
  color: #374151;
}
